...
sealed class InputEvent {
    data class Down(val x:Float,val y:Float,val id:Int=0):InputEvent()
    data class Move(val x:Float,val y:Float,val id:Int=0):InputEvent()
    data class Up  (val x:Float,val y:Float,val id:Int=0):InputEvent()
}
